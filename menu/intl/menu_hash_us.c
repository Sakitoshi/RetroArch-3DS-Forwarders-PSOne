...
const char *menu_hash_to_str_us(uint32_t hash)
{
   ...
   switch (hash)
   {
      ...
      case MENU_LABEL_VALUE_OPEN_ARCHIVE:
         return "Open";           // Sakitoshi: changed 'Open Archive As Folder' to 'Open'
      case MENU_LABEL_VALUE_LOAD_ARCHIVE:
         return "Closed";           // Sakitoshi: changed 'Load Archive With Core' to 'Closed'
      ...
      case MENU_LABEL_VALUE_CONTENT_SETTINGS:
         return "Game Menu";                             // Asdolo: changed 'Quick Menu' to 'Game Menu'
      ...
      case MENU_LABEL_VALUE_DISK_OPTIONS:
         return "Change Disc";                      // Sakitoshi: change 'Core Disk Options' to 'Change Disc'
      case MENU_LABEL_VALUE_CORE_OPTIONS:
         return "Core Options";
      case MENU_LABEL_VALUE_CORE_CHEAT_OPTIONS:
         return "Cheats";                           // Asdolo: changed 'Core Cheat Options' to 'Cheat'
      ...
      case MENU_LABEL_VALUE_DISK_INDEX:
         return "Disc Number";                      // Sakitoshi: change 'Disk Index' to 'Disc Number'
      ...
      case MENU_LABEL_VALUE_DISK_CYCLE_TRAY_STATUS:
         return "Open/Close Lid";             // Sakitoshi: change 'Disk Cycle Tray Status' to 'Open/Close Lid'
      ...
      case MENU_LABEL_VALUE_QUIT_RETROARCH:
         return "Quit Game";                      // Asdolo: changed 'Quit Retroarch' to 'Quit Game'
      ...
      case MENU_LABEL_VALUE_CLOSE_CONTENT:
         return "Reset Game";                      // Asdolo: changed 'Close Content' to 'Reset Game'
      ...
      case MENU_LABEL_VALUE_RESUME_CONTENT:
         return "Continue Game";                   // Asdolo: changed 'Resume Content' to 'Continue Game'
