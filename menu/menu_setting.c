      ...
      unsigned user)
{
...

   {
      ...
      snprintf(label_analog[user], sizeof(label_analog[user]),
               "Use %s Analog as Dpad", menu_hash_to_str(MENU_VALUE_RETROPAD)); // Sakitoshi
...
// Asdolo: Removed 'Start Core' menu option
/*
   CONFIG_ACTION(
         list, list_info,
...
// Asdolo: Removed 'Load Content' menu option
/*
   CONFIG_ACTION(
         list, list_info,
...
// Asdolo: Removed 'Load Recent' menu option
/*
...
// Asdolo: Removed 'Settings' menu option   
/*
   CONFIG_ACTION(
         list, list_info,
...
// Asdolo: Removed 'Information' menu option   
/*
   CONFIG_ACTION(
         list, list_info,
...
// Asdolo: Removed 'Restart Retroarch' menu option
/*
#ifndef HAVE_DYNAMIC
   CONFIG_ACTION(
         list, list_info,
...
// Asdolo: Removed 'Load Configuration' menu option
/*
   CONFIG_ACTION(
         list, list_info,
...
// Asdolo: Removed 'Save Current Config' menu option
/*
   CONFIG_ACTION(
         list, list_info,
...
// Asdolo: Removed 'Save New Config' menu option
/*
   CONFIG_ACTION(
         list, list_info,
...
// Asdolo: Removed 'Help' menu option
/*
   CONFIG_ACTION(
         list, list_info,
