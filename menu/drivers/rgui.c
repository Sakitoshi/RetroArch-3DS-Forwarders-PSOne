...
static void rgui_render_background(void)
{
   ...
   // Asdolo: removed green menu background
   /*
   ...
   rgui_fill_rect(fb_pitch, fb_width - 10, 5, 5, fb_height - 10, rgui_green_filler);
   */
}
...
static void rgui_render(void *data)
{
   ...
   // Asdolo: removed RetroArch and core versions
   /*
